...
string Ratcol(int x)
{
    ...
    // if(x<=1050) return "<td style=\"text-align: center;\"><span style=\"color:green;font-size: 15px;\">"+to_string(x)+"</span></td>";
         if(x<= 850)    return "<td style=\"text-align: center;\"><span style=\"color:#808080;font-size: 15px;\">"+to_string(x)+"</span></td>\n";
    else if(x<=1050)    return "<td style=\"text-align: center;\"><span style=\"color:#804000;font-size: 15px;\">"+to_string(x)+"</span></td>\n";
