...
int main(int argc,char *argv[])
{
    ...
    lim[1]={   1, 850,"#80808085","#808080","Retard"};
    lim[2]={ 850,1050,"#80400085","#804000","Newbie"};
    lim[3]={1050,1250,"#00800085","#008000","Pupil"};
    lim[4]={1250,1400,"#03A89E85","#03A89E","Specialist"};
    lim[5]={1400,1550,"#0000FF85","#0000FF","Expert"};
    lim[6]={1550,1750,"#AA00AA85","#AA00AA","Candidate Master"};
    lim[7]={1750,1950,"#FF8C0085","#FF8C00","Master"};
    lim[8]={1950,2550,"#FF000085","#FF0000","Grandmaster"};
    pair<string,string> YouSIR;
    for(int i=1;i<=8;i++) if(lim[i].L<=R[n]&&R[n]<=lim[i].R) YouSIR={lim[i].c2,lim[i].rnknm};
...
printf("            <p >  Rating: <b style=\"color: %s\">%.0lf</b></p>\n",YouSIR.first.c_str(),R[n]);printf("\n");
